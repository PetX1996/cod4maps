...
Visit www.braxi.net for latest news, maps and tutorials for Death Run.
...
[+] Gametype is automatically set to deathrun
...
[+] Added new abilities for mappers, see http://www.brax-online.pl/forum/viewtopic.php?f=44&t=211
...
[+] Added check if rank was hacked and will restart player's rank if so...
[+] Added time limit
