...
antibug()
{
	...
	//˙dajne sa d· strilaù na aktiv·tora, keÔ je tam pod t˝m jeho st·nkom, mne sa to nedarÌ, no fixol som to :)
	level.SecurityFiringTriggers = [];
	level.SecurityFiringTriggers[0] = spawn( "trigger_radius", (1650,300,0) , 0, 800, 300);
	
	trig = spawn( "trigger_radius", (44,-798,50) , 0, 300, 80); //Spawn( <classname>, <origin>, <flags>, <radius>, <height> )
...
main()
{
	...
	ambientPlay("ambient_mp_fnrp_piratas");
