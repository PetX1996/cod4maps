...
main()
{
	level.dr_zero_player_burn_time = 5; // dlzka horenia
	
    level._effect[ "fire21" ]	           			= loadfx( "misc/fire21" );
	level._effect[ "fire22" ]	           			= loadfx( "misc/fire21" );
	level._effect[ "playerfire" ]	           		= loadfx( "misc/playerfire" );
...
fire(index) {
	...
	t playsound("flame"); // zvuk z kill triggra
