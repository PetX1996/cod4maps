...
jump_height_trig()
{
	...
	deathrun\include\_mapper::SVStuckAllow(true);
...
//    level notify( "addtime",  "240" );
	...
	deathrun\include\_mapper::SVStuckAllow(false);
...
{
    deathrun\include\_mapper::SVLTimeLimitExpand(10);
}
...
text()
{
    for(;;)
    {
	    ...
	    wait 60;
		iPrintln("^1>> ^2Thanks for the huge help by Ratzee!");
    }
}
