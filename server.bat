...
iw3mp.exe +set punkbuster 0 +set dedicated 1 +set net_ip "0.0.0.0" +set net_port "28960" +set debug 1 +set con_debug 1 +sets gamestartup \"`date +"%D %T"`\" +set fs_game mods/stargate_out +exec server.cfg +exec mod.cfg +set scr_flying 1 +set scr_game_spectatetype 2 +set scr_hardcore 1 +set g_log "games_mp.log" +set ui_maxclients "64" +set g_gametype war +map mp_pyramid
